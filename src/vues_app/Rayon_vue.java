 ...
 * @author ARNAUD
 */
public class Rayon_vue extends javax.swing.JFrame {
...
//Ensuite tu fais ce que tu veut sur ton objet, comme par exemple le transformer en String
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("RAYON", jScrollPane2);
        ...
        jTabbedPane2.addTab("liste des livre du rayon", jScrollPane1);
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jTextField7, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 262, javax.swing.GroupLayout.PREFERRED_SIZE)
...
ray.make_Rayon(nom.getText());
int ID=ray.get_id(nom.getText());
dt = new DefaultTableModel();
dt=(DefaultTableModel) jTable1.getModel();
Object [] rayon ={ID,nom.getText(),""};           
 dt.addRow(rayon);
}
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
         ...
         Object nomu = jTable1.getValueAt(ligne,1);
           ...
           ray.get_livre_rayon(nomu.toString(), jTable2);
...
ray.edit_rayon(Integer.parseInt(jLabel2.getText()),nom.getText());
}
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        MessageFormat Header = new MessageFormat("LISTE DES RAYONS LE:"
            + " " + maDate.toString() + "");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Rayon_vue.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
